...
exports.run = async (client, message, args) => {
  ...
  var tr = [
    ...
    "**{cekilisadi}** isimli çekilişi silmek üzeresiniz. Onaylıyor musunuz? ``onay``", // 7
    "Çekiliş başarıyla silindi", // 8
  ...
  var en = [
    ...
    "Are you really want to delete the giveaway called with **{cekilisadi}**? If yes, type `confirm`",
  ...
  var onay;
    ...
    await message.channel
      ...
      cekilisler.splice(id-1, 1);
      var k = db.get("cekiliskanal_" + message.guild.id);
      client.channels.get(k).fetchMessage(secilen.split('-')[7]).then(a => {db.delete("katilimcilar_" + message.guild.id + "_" + a.id); a.delete(); });
...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ["cekilis-sil", "giveaway-delete", "delete-giveaway", "çekilişsil", "deletegiveaway", "çekiliş-sil", "çekilis-sil", "çekilissil", "cekilissil"],
  permLevel: 0
};

exports.help = {
  name: "cekilis-sil",
  description: "cekilis-sil",
  usage: "cekilis-sil"
};
